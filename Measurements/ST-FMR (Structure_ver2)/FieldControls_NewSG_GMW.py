...
doc = {
    ...
    'Hz Delay': 0,
    'Hz Max': 0.25,  # max voltage allowed through the amp
    'Hx Max': 10  # they are STFMR station's 
}

doc_RESOURCES = {
    'dsp_lockin': 'GPIB0::10::INSTR',    #STFMR station
    'keithley_2000': 'GPIB0::16::INSTR', #STFMR station
    'keithley_2400': 'GPIB0::20::INSTR', #STFMR station
    'gaussmeter': 'GPIB0::7::INSTR',
    'sig_gen_8257': 'GPIB0::18::INSTR',  #STFMR station
    'gmw' : 'nidaqmx',                   #GMW station
    'keithley_2000_gmw': 'GPIB2::16::INSTR', #GMW station
    'keithley_2400_gmw': 'GPIB2::20::INSTR', #GMW station
}
